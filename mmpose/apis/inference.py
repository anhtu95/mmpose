...
def vis_pose_result(model,
    ...
    #                 [1, 2], [1, 3], [2, 4], [3, 5], [4, 6], [5, 7],
    #                 [16, 18],
    #                 [16, 19], [16, 20], [17, 21], [17, 22], [17, 23],
    #                 [92, 93],
    #                 [93, 94], [94, 95], [95, 96], [92, 97], [97, 98],
    #                 [98, 99],
    #                 [99, 100], [92, 101], [101, 102], [102, 103],
    #                 [103, 104],
    #                 [92, 105], [105, 106], [106, 107], [107, 108],
    #                 [92, 109],
    #                 [109, 110], [110, 111], [111, 112], [113, 114],
    #                 [114, 115],
    #                 [115, 116], [116, 117], [113, 118], [118, 119],
    #                 [119, 120],
    ...
    #
    # elif dataset == 'TopDownMpiiDataset':
    #     skeleton = [[1, 2], [2, 3], [3, 7], [7, 4], [4, 5], [5, 6],
    #     [7, 8],
    ...
    # elif dataset in ('OneHand10KDataset', 'FreiHandDataset',
    #                  'PanopticDataset'):
    #     skeleton = [[1, 2], [2, 3], [3, 4], [4, 5], [1, 6], [6, 7],
    #     [7, 8],
    #                 [8, 9], [1, 10], [10, 11], [11, 12], [12, 13],
    #                 [1, 14],
    ...
    #     ]]
    #     pose_kpt_color = palette[[
    #         0, 0, 0, 0, 0, 4, 4, 4, 4, 8, 8, 8, 8, 12, 12, 12, 12, 16,
    #         16, 16,
    #         16
    #     ]]
    #
    # elif dataset == 'InterHand2DDataset':
    #     skeleton = [[1, 2], [2, 3], [3, 4], [5, 6], [6, 7], [7, 8],
    #     [9, 10],
    #                 [10, 11], [11, 12], [13, 14], [14, 15], [15, 16],
    #                 [17, 18],
    #                 [18, 19], [19, 20], [4, 21], [8, 21], [12, 21],
    #                 [16, 21],
    #                 [20, 21]]
    #
    #     pose_limb_color = palette[[
    ...
    #                               [7] * 2]
    #     pose_kpt_color = palette[[
    #         4, 4, 6, 6, 6, 6, 6, 6, 4, 4, 4, 4, 4, 7, 7, 7, 4, 4, 7, 7,
    #         7, 4
    #     ]]
    #
    # elif dataset == 'AnimalFlyDataset':
    #     skeleton = [[2, 1], [3, 1], [4, 1], [5, 4], [6, 5], [8, 7],
    #     [9, 8],
    #                 [10, 9], [12, 11], [13, 12], [14, 13], [16, 15],
    #                 [17, 16],
    #                 [18, 17], [20, 19], [21, 20], [22, 21], [24, 23],
    #                 [25, 24],
    ...
    #                 [11, 10], [12, 11], [14, 13], [15, 14], [16, 15],
    #                 [18, 17],
    #                 [19, 18], [20, 19], [22, 21], [23, 22], [25, 24],
    #                 [26, 25],
    #                 [27, 26], [29, 28], [30, 29], [31, 30], [33, 32],
    #                 [34, 33],
    #                 [35, 34]]
    #
